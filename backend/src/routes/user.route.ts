...
import { createTechnicianController, getTechnicianDetailController, listTechniciansController, updateTechnicianStatusController } from '../controllers/user.controller.js';
